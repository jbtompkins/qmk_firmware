 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Grv  | LCtl | LAlt | LGUI |      |                                       |      | RGUI | RAlt | RCtl |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |  /   |   =  |
 *                                 ,------|------|------|       |------+------+------.
 *                                 |      |      | Home |       | PgUp |      |      |
 *                                 | Enter| LOWR |------|       |------| RASE |Space |
 *                                 |      |      | End  |       | PgDn |      |      |
 *                                 `--------------------'       `--------------------'
 */
[DVRK] = LAYOUT_ergodox(
  ...
  KC_GRV,          KC_LCTL,     KC_LALT,       KC_LGUI, KC_TRNS,
                                                                  KC_TRNS, KC_TRNS,
                                                                           KC_HOME,
                                                         KC_ENT, TT(LOWR), KC_END,
  // right hand
...
[LOWR] = LAYOUT_ergodox(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SLSH, KC_EQL,  KC_TRNS,
